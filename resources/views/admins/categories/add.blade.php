...
@section('main')
    <section class="w-full p-10 column g-10">
       <form method="POST" onsubmit="PostRequest(event,this,MyFunc.Posted)" action="{{ url('admins/post/add/category/process') }}" class="w-full bg-light br-10 p-10 column g-10">
        ...
        <div class="column w-full g-5">
            ...
            <div class="w-full h-50 br-5 bg-dim cont border-1 border-color-silver">
                <input type="text" name="name" placeholder="i.e Instagram" class="inp input w-full h-full border-none bg-transparent br-5 required">
            </div>
        </div>
        ...
        {{-- SUBMIT BUTTON --}}
        <button class="post br-5 clip-5">Add Category</button>
