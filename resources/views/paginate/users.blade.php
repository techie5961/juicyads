...
@isset($transactions)
     @foreach ($transactions as $data)
                  <div style="border:1px solid var(--primary)" onclick="spa(event,'{{ url('users/transaction/receipt?id='.$data->id.'') }}')" class="w-full bg-light p-20 br-10 row align-center box-shadow g-10 space-between">
